...
public:
    Vec3d();
    Vec3d(double d);
    Vec3d(float new_x, float new_y, float new_z);
    float x, y, z;

    // Methods for obtaining magnitude (length) of vector
    inline double magnitude() { return sqrt(x * x + y * y + z * z); };
    inline double magnitude_squared() { return (x * x + y * y + z * z); };
    inline Vec3d normalized() { return Vec3d(x / this->magnitude(), y / this->magnitude(), z / this->magnitude()); }
};

// Vector operator definitions
inline Vec3d operator*(const Vec3d v1, const float a) { return Vec3d(a * v1.x, a * v1.y, a * v1.z); };
inline Vec3d operator*(const float a, const Vec3d v1) { return Vec3d(a * v1.x, a * v1.y, a * v1.z); };
inline Vec3d operator+(const Vec3d v1, Vec3d v2) { return Vec3d(v1.x + v2.x, v1.y + v2.y, v1.z + v2.z); }
inline Vec3d operator-(const Vec3d v1, const Vec3d v2) { return Vec3d(v1.x - v2.x, v1.y - v2.y, v1.z - v2.z); }
inline double dot(const Vec3d v1, Vec3d v2) { return v1.x * v2.x + v1.y * v2.z + v1.z * v2.z; }
